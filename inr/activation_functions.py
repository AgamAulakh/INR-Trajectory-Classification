...
class Sine(Layer):
    ...
    def __init__(self, in_size, out_size, **kwargs):
        ...
        self.siren_factor = float(kwargs.get("siren_factor", 30.0))
        self.linear = nn.Linear(in_size, out_size)
        self.weight_init()
    ...
    def weight_init(self):
        with torch.no_grad():
            ...
            w_std = np.sqrt(6.0 / num_input) / self.siren_factor
...
class ComplexWIRE(Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.linear = nn.Linear(in_size, out_size, bias=True, dtype=dtype)
